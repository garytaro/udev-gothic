...
do
  ...
  # JPDOC + NF
  "${BASE_DIR}/generator.sh" "$VERSION" "$FAMILYNAME_JPDOC" "$DISP_FAMILYNAME_JPDOC" 0 1 1 0 $italic_flag
  ...
  # LG + JPDOC + NF
  "${BASE_DIR}/generator.sh" "$VERSION" "$FAMILYNAME_NF_LIGA" "$DISP_FAMILYNAME_NF_LIGA" 1 1 1 0 $italic_flag
  ...
  # LG + JPDOC + NF + 35
  "${BASE_DIR}/generator.sh" "$VERSION" "$FAMILYNAME_NF_LIGA_35" "$DISP_FAMILYNAME_NF_LIGA_35" 1 1 1 1 $italic_flag
